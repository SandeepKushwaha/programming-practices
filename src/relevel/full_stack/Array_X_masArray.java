...
public class Array_X_masArray {
    public static void main(String[] args) throws IOException {
        BufferedReader read = new BufferedReader(new InputStreamReader(System.in));
        int t = Integer.parseInt(read.readLine());

        while (t > 0) {
//            String temp1 = read.readLine().trim();
            String[] temp2 = read.readLine().trim().split(" ");
            ...
            int[] s = new int[stamp.length];

            for (int i = 0; i < n; i++) {
                s[i] = Integer.parseInt(stamp[i]);
            }
    ...
    private static int xMas(int[] arr, int n, int x) {
        return 0;
    }
}*/
